; zona_ajuste.scm    version 1.13    11 de junio de 2018
;
;
;##############################################################################
; INSTALACIÓN
...
;     teclas para ejecutarlo (CTRL+ALT+Z). Para hacerlo tienes que ir a:
...
; "Zona de Ajuste". Lo seleccionas con el ratón y pulsas la combinación de teclas 
; que te gusta (en mi caso CTRL+ALT+Z)
;
;##############################################################################
...
; ------------------------------------------------------------------------------------------------
; Crear nuevas imágenes y capas necesarias a partir de la imagen de base
  (let* (
...
; ------------------------------------------------------------------------------------------------
; Creamos la nueva capa con la imagen de base
     (gimp-image-add-layer aimg background-dup -1)

; ------------------------------------------------------------------------------------------------
; Crea una máscara de capa a partir de nuestra selección
     (gimp-layer-create-mask background-dup ADD-SELECTION-MASK)
